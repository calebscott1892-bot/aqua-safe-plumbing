...
export const faqs: Faq[] = [
  {
    ...
    a: "We charge a minimum attendance fee that includes travel and the first 30 minutes on site within the Perth metro area. If more time is required, labour is charged in 15-minute increments.",
  },
  {
